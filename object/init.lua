...
---@comment Создаёт экземпляр класса. Если класс содержит функцию инициализации initialize - то в процессе вызывается она и в неё передаются все аргументы, поданные в эту функцию
